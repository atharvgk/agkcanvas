...
const sidebarEl = document.querySelector('.sidebar') as HTMLDivElement;
const roomLabelEl = document.getElementById('roomLabel') as HTMLSpanElement;
const statusDot = document.getElementById('statusDot') as HTMLSpanElement;
const statusText = document.getElementById('statusText') as HTMLSpanElement;
const toolBrushBtn = document.getElementById('toolBrush') as HTMLButtonElement;
const toolEraserBtn = document.getElementById('toolEraser') as HTMLButtonElement;
...
const sizeValueEl = document.getElementById('sizeValue') as HTMLSpanElement;
const undoBtn = document.getElementById('undo') as HTMLButtonElement;
const redoBtn = document.getElementById('redo') as HTMLButtonElement;
const roomModal = document.getElementById('roomModal') as HTMLDivElement;
...
const changeRoomBtn = document.getElementById('changeRoomBtn') as HTMLButtonElement;

let currentRoomId: string | null = null;
let wsConnection: ReturnType<typeof connectWS> | null = null;
...
if (sizeValueEl) sizeValueEl.textContent = `${parseInt(sizeEl.value, 10)}px`;
...
function joinRoom(roomId: string, solo: boolean = false, create: boolean = false) {
	isSoloMode = solo;
	if (wsConnection) {
...
function updateRoomLabel(roomId: string, isSolo: boolean) {
	if (isSolo) {
...
function renderUsers(users: Array<{ userId: string; username: string; color: string }>) {
	usersEl.innerHTML = '';
